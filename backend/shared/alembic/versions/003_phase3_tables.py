"""phase3 screenshot replication tables
...
def downgrade() -> None:
    op.drop_table("hint_queue")
    op.drop_table("uploaded_files")
    op.drop_index("idx_chart_replication_job", "chart_replication_states")
    op.drop_constraint("uq_chart_replication", "chart_replication_states")
    op.drop_table("chart_replication_states")
    op.drop_index("idx_screenshot_jobs_project", "screenshot_jobs")
